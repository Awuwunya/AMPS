MysticCave_Header:
	...
	sHeaderTempo	$01, $4A
	sHeaderCh	$05, $03
	sHeaderDAC	MysticCave_DAC1, $08
	sHeaderDAC	MysticCave_DAC2, $00, dMeow
...
MysticCave_Loop5:
	...
	sVoice		$01
	dc.b nC5, $06, nRst, $12, $06, nRst, $12
	sCall		MysticCave_FM45DAC2_1
...
MysticCave_FM45DAC2_1:
	dc.b nC5, $08, nB4, $04, nC5, $08, nB4, $04
	dc.b nC5, $0C
	sRet
...
MysticCave_DAC1:
	dc.b nRst, $30, $18, dLowKick, $0C, $08, $04

.loop	dc.b dLowKick, $08, $0C, $04, dSnare, $0C, dLowKick, $08
	dc.b $0C, dSnare, $04, dLowKick, $0C, dSnare, dLowKick, dLowKick
	dc.b $08, $0C, $04, dSnare, $0C, dLowKick, $08, $0C
	dc.b dSnare, $04
...
MysticCave_DAC2:
	sVoice		dMeow
	dc.b nA3, $14, nB3, $04, nC4, $0C, nE4, $0C
	dc.b nEb4, $0C, nE4, $0C, nG4, $08, nE4, $10
